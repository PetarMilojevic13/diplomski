...
import { isRentalActive } from '../utils/iznajmljivanjeHelper';

const Iznajmljivanje = mongoose.model('Iznajmljivanje');
const Film = mongoose.model('Film');
const User = mongoose.model('User');

// GET /api/iznajmljivanja - Get all rentals (admin)
export const getAllIznajmljivanja = async (req: Request, res: Response) => {
    try {
...
export const getIznajmljivanjaByKorisnik = async (req: Request, res: Response) => {
    try {
...
export const getAktivnaIznajmljivanja = async (req: Request, res: Response) => {
    try {
        const { kor_ime } = req.params;
...
export const createIznajmljivanje = async (req: Request, res: Response) => {
    try {
...
export const vratiIznajmljivanje = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
...
export const getStatistikaIznajmljivanja = async (req: Request, res: Response) => {
    try {
        const { kor_ime } = req.params;
...
export const deleteIznajmljivanje = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
...
export const checkRentalConflict = async (req: Request, res: Response) => {
    try {
...
export const getRentalStatisticsAdmin = async (req: Request, res: Response) => {
    try {
        ...
        for (const r of sve) {
            ...
            if (start && end) {
                if (danas >= start && danas < end) activeRentals++;
                else if (danas >= end) returnedRentals++;
            } else if (start && !end) {
                // no end date — treat as active if started
                if (danas >= start) activeRentals++;
            }
        }
...
export const getMonthlyRentalTrends = async (req: Request, res: Response) => {
    try {
